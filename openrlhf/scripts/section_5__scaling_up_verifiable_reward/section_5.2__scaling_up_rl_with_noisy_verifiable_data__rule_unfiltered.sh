...
if [ "$NODE_RANK" -eq 0 ]; then
    ...
    ray job submit --address="http://127.0.0.1:8265" \
        ...
        --math_rule_common_score_fn symeval \
        ...
        --wandb_project cot \
        --wandb_run_name "exp_ppo_cosine_qwq_webit_sp4_ep1_30k_bs512_epoch1_w10_c2_ngram40_pen0d05_gg100_99_16k_judge_symeval_boxed_unfiltered_$(date "+%Y%m%d_%H%M%S")"
else
