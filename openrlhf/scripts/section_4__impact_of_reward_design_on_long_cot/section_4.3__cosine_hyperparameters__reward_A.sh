...
if [ "$NODE_RANK" -eq 0 ]; then
    ...
    ray job submit --address="http://127.0.0.1:8265" \
        ...
        --math_rule_cosine_scale_min_value_wrong 0 \
        --math_rule_cosine_scale_max_value_wrong 0 \
        --math_rule_cosine_scale_min_value_correct 10 \
        --math_rule_cosine_scale_max_value_correct 0 \
        ...
        --wandb_project cot \
        --wandb_run_name "exp_ppo_cosine_qwq_sp4_ep4_bs512_epoch1_w0_c10_ngram40_pen0d05_gg100_99_16k_$(date "+%Y%m%d_%H%M%S")"
else
